...
public class TileEntityEnderFurnaceAndFuel extends TileEntity implements ISidedInventory {
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			EnderFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
			...
			if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air){
				...
				if(block == All_Mod_Blocks.EnderFurnace){
					return 200;
				}
			}
			//Fuel here
			if(item == All_Mod_Items.ReDust) return 1600;
