...
public class ReCustCraftingManager
{
    ...
    public static final ReCustCraftingManager instance = new ReCustCraftingManager();
    ...
    public ReCustCraftingManager()
    {
        //this.addRecipe(new ItemStack(Blocks.hopper, 64), new Object[] {"I I", "ICI", " I ", 'I', Items.iron_ingot, 'C', Blocks.chest});
